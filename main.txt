...
def app_sidebar():
    ...
    if current_page == "Audio Analysis":
    ...
    <div style="text-align: center; padding: 1rem 0;">
        ...
        <p style="color: #64748B; font-size: 0.9rem; margin-top: 0;">{subtitle_text}</p>
    </div>
...
def main():
    ...
    if not st.session_state['logged_in']:
        ...
        base_path = "C:/Users/Sandra Tang/OneDrive - Tunku Abdul Rahman University College (1)/Documents/Emotion Detection Text Sentiment Analysis Final"
